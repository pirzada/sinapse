...
namespace AForge.Mathematics
{
	...
	public class Tools
	{
        ...
        /// <param name="x"></param>
        /// <returns></returns>
        public static double BesselZero(double x)
        {
            double ax;
        ...
        /// <param name="x"></param>
        /// <returns></returns>
        public static double BesselOne(double x)
        {
            double ax;
            double y;
            double ans1, ans2;
        ...
        public static double Bessel(int n, double x)
        {
            ...
            if (n == 0) return BesselZero(x);
            if (n == 1) return BesselOne(x);
        ...
        /// <param name="x"></param>
        /// <returns></returns>
        public static double SecondBesselZero(double x)
        {
            if (x < 8.0)
            {
                double y = x * x;
                ...
                return (ans1 / ans2) + 0.636619772 * BesselZero(x) * Math.Log(x);
            }
            else
            {
                double z = 8.0 / x;
        ...
        /// <param name="x"></param>
        /// <returns></returns>
        public static double SecondBesselOne(double x)
        {
            if (x < 8.0)
            {
                double y = x * x;
                ...
                return (ans1 / ans2) + 0.636619772 * (BesselOne(x) * Math.Log(x) - 1.0 / x);
            }
            else
            {
                double z = 8.0 / x;
        ...
        /// <param name="x"></param>
        /// <returns></returns>
        public static double SecondBessel(int n, double x)
        {
            double by, bym, byp, tox;

            if (n == 0) return SecondBesselZero(x);
            if (n == 1) return SecondBesselOne(x);

            tox = 2.0 / x;
            by = SecondBesselOne(x);
            bym = SecondBesselZero(x);
            for (int j = 1; j < n; j++)
            {
                byp = j * tox * by - bym;
                bym = by;
        ...
        public static double Gamma(double x)
        {
            ...
            x -= 2.0;
            p = EvaluatePolynom(x, P, 6);
            q = EvaluatePolynom(x, Q, 7);
            return z * p / q;
        ...
        private static double GammaStirling(double x)
        {
            ...
            w = 1.0 + w * EvaluatePolynom(w, STIR, 4);
        ...
        /// <param name="x"></param>
        /// <returns></returns>
        public static double GammaIncompleteComplemented(double a, double x)
        {
            ...
            ax = a * Math.Log(x) - x - GammaLogarithm(a);
        ...
        public static double GammaIncomplete(double a, double x)
        {
            ...
            if (x > 1.0 && x > a) return 1.0 - GammaIncompleteComplemented(a, x);
        ...
        /// </returns>
        public static double ChiSquareLeft(double df, double x)
        {
            if (x < 0.0 || df < 1.0) return 0.0;

            return GammaIncomplete(df / 2.0, x / 2.0);
        ...
        /// <param name="x">double value</param>
        /// <returns>
        ///  Returns the area under the right hand tail
        ///  (from x to infinity) of the Chi square probability
        ///  density function with v degrees of freedom.
        /// </returns>
        public static double ChiSquareRight(double df, double x)
        {
            if (x < 0.0 || df < 1.0) return 0.0;

            return GammaIncompleteComplemented(df / 2.0, x / 2.0);
        ...
        public static double Poisson(int k, double x)
        {
            ...
            return GammaIncompleteComplemented((double)(k + 1), x);
        }
        ...
        /// <param name="x">double value</param>
        /// <returns></returns>
        public static double PoissonToInfinity(int k, double x)
        {
            if (k < 0 || x < 0) return 0.0;

            return GammaIncomplete((double)(k + 1), x);
        }
        ...
        public static double Normal(double a)
        {
            ...
            if (z < SQRTH) y = 0.5 + 0.5 * Error(x);
            else
            {
                y = 0.5 * ErrorComplementary(z);
                if (x > 0) y = 1.0 - y;
            }
        ...
        /// <param name="a"></param>
        /// <returns></returns>
        public static double ErrorComplementary(double a)
        {
            double x, y, z, p, q;
            ...
            if (x < 8.0)
            {
                p = EvaluatePolynom(x, P, 8);
                q = EvaluatePolynomOne(x, Q, 8);
            }
            else
            {
                p = EvaluatePolynom(x, R, 5);
                q = EvaluatePolynomOne(x, S, 6);
            }
        ...
        public static double Error(double x)
        {
            ...
            if (Math.Abs(x) > 1.0) return (1.0 - ErrorComplementary(x));
            z = x * x;
            y = x * EvaluatePolynom(z, T, 4) / EvaluatePolynomOne(z, U, 5);
            return y;
        }
        ...
        /// <param name="N"></param>
        /// <returns></returns>
        public static double EvaluatePolynom(double x, double[] coef, int N)
        {
            double ans;
        ...
        /// <param name="N"></param>
        /// <returns></returns>		
        public static double EvaluatePolynomOne(double x, double[] coef, int N)
        {
            double ans;
        ...
        public static double GammaLogarithm(double x)
        {
            ...
            if (x < 13.0)
            {
                ...
                x -= 2.0;
                p = x * EvaluatePolynom(x, B, 5) / EvaluatePolynomOne(x, C, 6);
                return (Math.Log(z) + p);
            }
        ...
        /// <param name="xx"></param>
        /// <returns></returns>
        public static double Beta(double aa, double bb, double xx)
        {
            ...
            y += t + GammaLogarithm(a + b) - GammaLogarithm(a) - GammaLogarithm(b);
            y += Math.Log(w / a);
            if (y < MINLOG)
                t = 0.0;
            else
        ...
        private static double pseries(double a, double b, double x)
        {
            ...
            {
                t = GammaLogarithm(a + b) - GammaLogarithm(a) - GammaLogarithm(b) + u + Math.Log(s);
                if (t < MINLOG) s = 0.0;
                else s = Math.Exp(t);
            }
            return s;
