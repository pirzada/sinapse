...
namespace AForge.Neuro
{
	...
	///
    [Serializable]
	public class DynamicActivationNetwork : DynamicNetwork
	{
		/// <summary>
		...
		/// </example>
		/// 
		public DynamicActivationNetwork( IActivationFunction function, int inputsCount, params int[] neuronsCount )
