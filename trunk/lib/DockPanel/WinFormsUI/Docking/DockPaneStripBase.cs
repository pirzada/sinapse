...
namespace WeifenLuo.WinFormsUI.Docking
{
    public abstract class DockPaneStripBase : Control
    {
        ...
        // FIX 2009-03-02: http://sourceforge.net/forum/forum.php?thread_id=1738676&forum_id=402316 
        // Check if its the midddle buttton and if so close the active content, like Visual Studio. 
